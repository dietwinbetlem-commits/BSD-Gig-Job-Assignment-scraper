...
def scrape_striive_auth(platform, results_list):
    """
    Striive: uitgeschakeld. React SPA laadt opdrachten via een private
    authenticated API zonder scrape-baar endpoint.
    """
    log.info('Striive: uitgeschakeld (React SPA / private API)')
    return
